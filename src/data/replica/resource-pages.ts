...
export const resourceReplicaPages: ReplicaPage[] = [
  ...
  },
  {
    ...
    type: "landing-or-help",
    title: "象棋图标 - 相弈象棋",
    description: "复刻源站当前象棋图标说明页，承接资源页中的站内跳转。",
    heroTitle: "象棋图标",
    sections: [
      {
        title: "使用说明",
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            href: "https://www.mianfeiziti.com",
            external: true
          },
          {
            label: "Poppins",
  ...
  },
  {
    ...
    type: "landing-or-help",
    title: "制作象棋视频 - 相弈象棋",
    description: "复刻源站当前视频制作教程页，承接资源页中的站内跳转。",
    heroTitle: "制作象棋视频",
    sections: [
      {
        title: "教程说明",
      ...
      },
      {
        ...
        body: [],
        list: [
          "电脑内存（RAM）至少为 4G（苹果或其他电脑均可）。",
          "好的处理器（英特尔酷睿 i5 2 代或更高版本，其他同等处理器亦可）。",
          "高清摄像头（可用电脑内置网络摄像头，但高清外置网络摄像头更佳，如罗技 C920）。",
      ...
      },
      {
        ...
        list: [
          "Windows、Mac 或 Linux。",
          "推荐使用谷歌 Chrome 浏览器，但火狐或其他现代浏览器均可。",
          "OBS Studio 软件（免费开源软件）。"
        ],
        links: [
          {
      ...
      },
      {
        ...
        body: [
          "关于 OBS Studio 的安装和设置，请参照 OBS 实用教程。（顺便给视频点个赞，支持一下作者吧！）",
          "在电脑上完成 OBS Studio 设置后，可先录制几个视频试试水；如无问题，再正式开始录制视频。查看录制好的视频，检查音频、视频及录屏质量是否良好，随后再进行下一步。"
        ]
      },
      {
        title: "在我们的网站界面开始录制",
        body: [],
        list: [
          "确保 OBS 录制功能已开启，并将其最小化。",
          "关闭所有桌面通知（如 WhatsApp 或其他应用程序），避免视频录制中断。",
      ...
      },
      {
        title: "本网站自带功能",
        body: [
          "在浏览器中打开我们的网站并登录账号。在游戏大厅开始新游戏或加入公开游戏。在进行上述操作时，可以一边录制一边讲解，也可在游戏开始后进行录制。",
          "除了实战录制外，还可使用我们的棋盘编辑器或谜题编辑器。",
          ...
          "完成视频录制后，检查是否符合上述质量标准。检查完毕后，即可将其发送至 help@xiangqi.com。我们后续将联系投稿人，说明视频用途，并在使用视频时署上投稿人的名字，以致谢意。"
        ],
        links: [
          {
            label: "棋盘编辑器",
  ...
  },
  {
    ...
    type: "landing-or-help",
    title: "中文短语 - 相弈象棋",
    description: "复刻源站当前中文短语页，承接资源页中的站内跳转。",
    heroTitle: "中文短语",
    sections: [
      {
        title: "中文短语",
