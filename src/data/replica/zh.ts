...
const pages: ReplicaPage[] = [
  ...
  },
  {
    ...
    cta: [{ label: "返回文章列表", href: "/articles/", variant: "secondary" }],
    sections: articleSections("相弈象棋 产品更新 2024年8月", [
      "您在相弈象棋的贡献",
      "这一年，我们的社区创造了以下辉煌战绩：完成了 6,227,308 场棋局，破解了 894,221 道象棋题目，分析复盘了 471,110 个局面，拥有 320,294 位活跃玩家，99个国家的象棋爱好者参与其中。",
      "最新产品更新",
      "为了让您的象棋体验更加顺畅，我们对网站和手机应用做了多项改进：",
